...
public class AjaxRes implements Serializable  {
	...
	public int getResMsgInt() {
		return resMsgInt;
	}
	public void setResMsg(String resMsg) {
		this.resMsg = resMsg;
	}
	public void setResMsg(int resMsgInt) {
		this.resMsgInt = resMsgInt;
	}
	...
	public void setSucceed(Object obj,int resMsg){
		this.obj = obj;
		this.setRes(resMsg);
	}
	 ...
	 * @param resMsg 返回码值解析
	 */
	public void setSucceedMsg(int resMsg){
		this.setRes(Const.SUCCEED);
		this.setResMsg(resMsg);
	}
	/**
