				...
				<div class="ibox float-e-margins">
			        <div class="ibox-title">
			          	<div class="col-lg-12" style="text-align:right;margin-top:-20px;">
							<button data-toggle="modal" data-target="#Modal_doctor"  class="btn btn-primary" type="button"><i class="fa fa-plus"></i>&nbsp;添加医生</button>
			           	</div>
				    </div>	
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">医生添加</h4>
					</div>
					<div class="modal-body">
						<form class="form-horizontal aForm" role="form" id="Form_doctor" onsubmit="return fAdd()">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="name" class="form-control" placeholder="医生姓名" maxlength="50" required>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea style="height:120px;width:100%" maxlength="1000" name="info" class="form-control" placeholder="医生简介(1000字)" required></textarea>
								</div>
							</div>
							<div class="form-group">
						...
						if(ret.length == 0){
							...
							for(var i=0;i<ret.length;i++){
								...
								document.getElementById('dTable').innerHTML += '<tr class="gradeX">'
													...
													+ stateStr
													+'<td class="center">'
														+'<a href="../appAdminDoctor/doctorDetailPage?'+ ret[i]['id'] +'">'
				...
				if(docObj.value.length > 1 && docObj.value) {     
					if(type == "JPG" || type == "jpg" || type == "jpeg" || type == "JPEG" || type == "ico" || type == "ICO" || type == "png" || type == "PNG") {
						if(docObj.size > 4194304){//文件大小判断
							...
							document.getElementById("buttonUpload").style.display = "inline";//上传按钮显示
