					...
					<div class="ibox-content">
							<form class="form-horizontal aForm" role="form" id="Form_doctor_edit" onsubmit="return fSubmit()">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" id="name" name="name" value="${list.name }" class="form-control" placeholder="药师姓名" maxlength="50" required>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea style="height:120px;width:100%" maxlength="1000" name="info" id="info" class="form-control" placeholder="药师简介(1000字)" required>${list.info }</textarea >
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group border-top white-bg dashboard-header" style="margin-top:60px">
									<div class="col-sm-6 text-right">
										<a href="../appAdminDoctor/seniorPage"><button type="button" class="btn btn-w-m btn-default">返回</button></a>
									</div>
					...
					$.ajax({
						...
						success : function(data) {
							...
							if(obj.res == 0){
								...
								window.location.href = '../appAdminDoctor/seniorPage';
							}
						}
					});
				}else{
