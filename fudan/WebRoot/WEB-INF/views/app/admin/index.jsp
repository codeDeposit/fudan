...
<html>
	...
	<body>
	    <div id="wrapper" style="background:#3ab3a5;">
	    	<div style="width:220px;position:fixed;top:0px;height:100%;overflow:hidden">
		        <nav class="navbar-default navbar-static-side" role="navigation" style="height:100%;top:0px;left:0px;overflow-y: scroll;width:235px;">
		            <div class="sidebar-collapse" style="background: #3ab3a5 !important;">
		                <ul class="nav" id="side-menu">
		                    <li class="nav-header" style="border:0px;">
		                            ...
		                            <a data-toggle="dropdown" class="dropdown-toggle" href="index.html#">
		                                <span class="clear">
			                                <span class="block m-t-xs">
				                            	<strong class="font-bold" style="color:#fff">${admin.name }</strong>
				                            </span>
	        ...
	        <div id="page-wrapper" class="gray-bg dashbard-1">
	            <div class="row border-bottom" style="border-bottom:1px solid #fff !important;">
	                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
	                    <div class="navbar-header">
	                        <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="javascript:void(0)"><i class="fa fa-bars"></i> </a>
	                    </div>
	                    <ul class="nav navbar-top-links navbar-right" style="border:0px;">
	                        <li style="border:0px;">
	                        ...
	                        <li style="border:0px;" class="dropdown">
