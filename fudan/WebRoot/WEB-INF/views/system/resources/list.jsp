...
<link rel="stylesheet" href="${jypath}/pc/plugins/zTree/3.5/zTreeStyle.css" />
<script src="${jypath}/pc/plugins/zTree/3.5/jquery.ztree.core-3.5.min.js"></script>
</head>
<body>
			...
			<div class="col-xs-12">
				...
				<div class="widget-header widget-header-large">				
					<div class="widget-main customBtn">	
						<button title="首页菜单" value='0' class="btn btn-xs btn-success"><i class="icon-circle-blank"></i></button>	
						<button title="选择显示层级" value='1' class="btn btn-xs"><i class="icon-desktop"></i></button>					
...
<script src="${jypath}/pc/js/system/resources/resources.js"></script>
</body>
</html>