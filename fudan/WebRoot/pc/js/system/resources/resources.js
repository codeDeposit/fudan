...
function setNodes(id,parentid,nodes,html,level,permitBtn){
	if(nodes!=null&&nodes.length>0){
		...
		for(var i = 0;i<nodes.length;i++){
    		 ...
    		 if(i==nodes.length-1)
    			 html += "<img src='"+jypath+"/pc/css/system/system/images/joinbottom.gif' class='joinMiddle'/>";
    		 else
    			 html += "<img src='"+jypath+"/pc/css/system/system/images/join.gif' class='joinMiddle'/>";
