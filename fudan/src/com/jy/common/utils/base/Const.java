...
public class Const {
	...
	public static final String IMG(){
		...
		String imgUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+"/image/";
		return imgUrl;
	}
	 ...
	 * 图片路径
	 */
	public static final String IMG(String url){
		HttpServletRequest request = ((ServletRequestAttributes)RequestContextHolder.getRequestAttributes()).getRequest();	
		String imgUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+"/image/" + url;
		return imgUrl;
	}
	 ...
	 * 空图片路径
	 */
	public static final String NULL_IMG(){
		HttpServletRequest request = ((ServletRequestAttributes)RequestContextHolder.getRequestAttributes()).getRequest();	
		String imgUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+"/image/default/null.png";
		return imgUrl;
	}
	/**
	 *邮箱配置文件位置
