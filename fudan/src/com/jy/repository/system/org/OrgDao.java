...
public interface OrgDao extends BaseDao<Org>{
	...
	public Org selectBy(String orgId);
	/**
	 * 获取所有部门
	 */
	 ...
	 * 获取所有基础部门
	 */
	public List<Org> selectBaseBranch(Org org);
	/**
	 * 获取本公司的所有部门
	 * @return
	 */
	 ...
	 * @return
	 */
	public List<Org> selectDetails(@Param("orgId")String orgId);
	/**
	 * 查询用户所在的组织
	 * @param accountId
	 * @return
	 */
	public String selectByAccountId(@Param("userId")String accountId);
